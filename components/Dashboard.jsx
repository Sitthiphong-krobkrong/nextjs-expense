...
export default function Dashboard({ transactions }) {
  ...
  const statCards = [
    ...
    },
    {
      ...
      accentColor: "#0ea5e9",
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-sky-600 dark:text-sky-400" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <>
      {/* Doughnut Chart Card */}
      <div className="glass-card mb-6 rounded-3xl shadow-xl shadow-cyan-900/5 p-6 sm:p-8 relative overflow-hidden transition-colors duration-300">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-cyan-400/8 rounded-full blur-3xl pointer-events-none -z-10" />
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex items-center justify-center gap-5">
            {[
              ...
              { label: t("dash_balance_label"), bg: "bg-sky-400" },
            ].map(({ label, bg }) => (
      ...
      {/* Bar Chart — monthly */}
      {monthlyData.hasData && (
        <div className="glass-card rounded-3xl shadow-xl shadow-cyan-900/5 p-6 mb-8 relative overflow-hidden transition-colors duration-300">
          <div className="flex items-center gap-3 mb-5">
            <div className="w-9 h-9 rounded-xl flex items-center justify-center bg-cyan-100 dark:bg-cyan-900/40">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-cyan-600 dark:text-cyan-400">
